...
<div class="main-body mt-4">
   <div x-data="{open:false}" class="flex justify-end items-center mb-3">
       <div @click="open = true"  class="bg-nav px-6 text-white p-2 rounded-full space-x-2 shadow-md cursor-pointer hover:bg-green-500 flex">
           ...
           <h1>Add Student</h1>
           <div tabindex="0" class="z-40 overflow-auto  top-0 bottom-0 right-0 w-full h-full fixed" style="background-color: rgba(0,0,0,.5);" x-show="open">
