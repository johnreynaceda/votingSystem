            ...
            <div class="body p-2">
                <form action="">
                    <div class="mb-5 text-side">
                        ...
                        <input wire:model="firstname" type="text" class="h-8 w-full outline-none focus:border-green-400 text-sm px-3 mt-1 focus:shadow-md rounded-sm border" placeholder="Enter Campus Name">
                    </div>
    ...
    <div class=" mt-3 grid grid-cols-4 gap-4">
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                ...
                <div class="text"><h1 class="font-medium text-center underline">ISULAN CAMPUS</h1></div>
            </div>
        </div>
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                <div class="icon"><i class="material-icons md-48">house</i></div>
                <div class="text"><h1 class="font-medium text-center underline">ACCESS CAMPUS</h1></div>
            </div>
        </div>
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                <div class="icon"><i class="material-icons md-48">house</i></div>
                <div class="text"><h1 class="font-medium text-center underline">TACURONG CAMPUS</h1></div>
            </div>
        </div>
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                <div class="icon"><i class="material-icons md-48">house</i></div>
                <div class="text"><h1 class="font-medium text-center underline">BAGUMBAYAN CAMPUS</h1></div>
            </div>
        </div>
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                <div class="icon"><i class="material-icons md-48">house</i></div>
                <div class="text"><h1 class="font-medium text-center underline">LUTAYAN CAMPUS</h1></div>
            </div>
        </div>
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                <div class="icon"><i class="material-icons md-48">house</i></div>
                <div class="text"><h1 class="font-medium text-center underline">KALAMANSIG CAMPUS</h1></div>
            </div>
        </div>
        <div class="bg-gradient-to-r from-main text-white hover:text-side cursor-pointer via-green-400 to-main rounded-md shadow-md ">
            <div class="flex flex-col p-1  justify-center items-center">
                <div class="icon"><i class="material-icons md-48">house</i></div>
                <div class="text"><h1 class="font-medium text-center underline">PALIMBANG CAMPUS</h1></div>
            </div>
        </div>
