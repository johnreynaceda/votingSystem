<div>
    <div class=" border rounded-md shadow-md">
        <div class="header p-2 border-b space-x-2 flex text-side  border-green-500">
            ...
            <h1 class="font-medium">Add Party-list</h1>
        ...
        <div class="body p-2">
            <form action="">
                <div class="mb-3 text-side">
                    ...
                    <input wire:model="partylist_name" type="text" class="h-8 w-full outline-none focus:border-green-400 text-sm px-3 mt-1 focus:shadow-md rounded-sm border" placeholder="Enter Party-list">
                    @error('partylist_name') <span class="text-red-700 text-sm error">{{ $message }}</span> @enderror
                </div>
                <div class="mb-5 text-side">
                    <label for="">Campus:</label>
                    <select wire:model="campus" type="text" class="h-8 w-full outline-none focus:border-green-400 text-sm px-3 mt-1 focus:shadow-md rounded-sm border" placeholder="Enter Campus Name">
                ...
                <div class="flex justify-end">
                    ...
                    <button wire:click.prevent="save" class="bg-nav p-1 focus:outline-none rounded-full px-6 text-white shadow-md hover:bg-green-400">SAVE</button>
                </div>
            </form>
        </div>
    </div>
